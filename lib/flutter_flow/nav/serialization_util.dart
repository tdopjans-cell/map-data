  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case BookletItemsRow:
            return BookletItemsRow(data);
          case PlaceLevelConfigRow:
            return PlaceLevelConfigRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case RouteVersionsRow:
            return RouteVersionsRow(data);
          case RuleEntriesRow:
            return RuleEntriesRow(data);
          case RuleSetsRow:
            return RuleSetsRow(data);
          case StopsRow:
